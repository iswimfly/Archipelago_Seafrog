...
item_table: List[ItemDict] = [
    ...
    # Seafrog Stuff Starts Here

    # Master Gears
    {'name':"Skraken Master Gear",'type':SeafrogType.MasterGear},
    {'name':"Metal Beak Master Gear",'type':SeafrogType.MasterGear},
    {'name':"Gerald Master Gear",'type':SeafrogType.MasterGear},
    
    # ModChips
    {'name':"Wellness Chip", 'type':SeafrogType.ModChip},
    {'name':"Eco Chip", 'type':SeafrogType.ModChip},
    {'name':"Tubular Chip", 'type':SeafrogType.ModChip},
    {'name':"Radical Chip", 'type':SeafrogType.ModChip},
    {'name':"Reckless Chip", 'type':SeafrogType.ModChip},
    {'name':"Joyride Chip", 'type':SeafrogType.ModChip},
    {'name':"Hasty Heart Chip", 'type':SeafrogType.ModChip},
    {'name':"Easy Peasy Chip", 'type':SeafrogType.ModChip},
    {'name':"Quick Chip", 'type':SeafrogType.ModChip},
    {'name':"Mag Wall Chip", 'type':SeafrogType.ModChip},
    {'name':"Carbon Neutral Chip", 'type':SeafrogType.ModChip},
    {'name':"Mag Bumper Chip", 'type':SeafrogType.ModChip},
    {'name':"Swift Chip", 'type':SeafrogType.ModChip},
    {'name':"Gas Can Chip", 'type':SeafrogType.ModChip},
    {'name':"Gas Guzzler Chip", 'type':SeafrogType.ModChip},
    {'name':"Fit Fiddle Chip", 'type':SeafrogType.ModChip},
    {'name':"Mag Plate Chip", 'type':SeafrogType.ModChip},
    {'name':"Redline Chip", 'type':SeafrogType.ModChip},
    {'name':"Hot Doggin' Chip", 'type':SeafrogType.ModChip},
    {'name':"Boot Scoot Chip", 'type':SeafrogType.ModChip},
    {'name':"Eggshell Chip", 'type':SeafrogType.ModChip},
    {'name':"Lil Buddy Chip", 'type':SeafrogType.ModChip},
    {'name':"Bodacious Chip", 'type':SeafrogType.ModChip},
    {'name':"Mega Mag Chip", 'type':SeafrogType.ModChip},

    # Potato Chip
    {'name':"Potato Chip", 'type':SeafrogType.PotatoChip},
    # Ship-specific Items
    

    # Manuals
    {'name':"Attacking", 'type':SeafrogType.MechanicManual},
    {'name': "Manual Tricking",'type': SeafrogType.MechanicManual},
    {'name' : "Rocket Wrench",'type':SeafrogType.MechanicManual}
]

progression_group_table: Dict[str, Set[str]] = {
    "MagWall":{"Quick Chip", "Mag Wall Chip", "Mega Mag Chip"},
    "MagBumper":{"Mag Bumper Chip", "Fit Fiddle Chip", "Mega Mag Chip"},
    "MagPlate":{"Mag Plate Chip", "Hot Doggin' Chip", "Mega Mag Chip"},
}
