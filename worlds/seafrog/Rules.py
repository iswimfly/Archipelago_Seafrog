...
def canBeatAlbatross(state: CollectionState, player: int) -> bool:
    return state.has("Skraken Master Gear") and state.has("Metal Beak Master Gear") and state.has("Gerald Master Gear")
